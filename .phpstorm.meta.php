...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\iperez\source\repos\copi\CB.app\public\storage' => 'string',
            ...
            'logging.channels.error_tracking.driver' => 'string',
            'logging.channels.error_tracking.path' => 'string',
            'logging.channels.error_tracking.level' => 'string',
            'logging.channels.error_tracking.days' => 'integer',
            'logging.channels.error_tracking.permission' => 'integer',
            'mail.default' => 'string',
            ...
            'services.cardnet.env' => 'string',
            'services.cardnet.merchant_id' => 'string',
            'services.cardnet.terminal_id' => 'string',
            'services.cardnet.token' => 'string',
            'services.cardnet.environment' => 'string',
            'services.payment.driver' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\iperez\\source\\repos\\copi\\CB.app\\public\\storage',
...
'logging.channels.errorlog.replace_placeholders','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.error_tracking.driver',
'logging.channels.error_tracking.path','logging.channels.error_tracking.level','logging.channels.error_tracking.days','logging.channels.error_tracking.permission','mail.default',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.stripe.key','services.stripe.secret','services.cardnet.env',
'services.cardnet.merchant_id','services.cardnet.terminal_id','services.cardnet.token','services.cardnet.environment','services.payment.driver',
...
'web','api',);
        registerArgumentsSet('routes', 'home','about','cont',
'envios','empleos','responsabilidad','realizar-intercambio','como-vender',
'realizar-compra','registrarse','ayuda','contraseña','historial',
'items.search_header','intercambio','compra',
'convertir.imagenes','items.categoria29','items.soloCategoria29','items.search',
'items.info','categorias.show','items.show','producto.detalle','carrito.show',
'carrito.agregar','carrito.eliminarItem','carrito.vaciar','carrito.checkout_index','carrito.pago_procesar',
'carrito.carrito_update','carrito.marcarSeleccionados','carrito.tarjetas_store','carrito.tarjetas_usar','carrito.tarjetas_destroy',
'carrito.actualizar_Paquete','carrito.carrito_eliminarPaquete','carrito.paquetes_listar','carrito.paquetes_obtener','carrito.paquetes_crear',
'carrito.paquetes_editar','carrito.items_usuario','carrito.get_Negociaciones','carrito.save_negociaciones','carrito.',
'carrito.negociaciones.ver','negociaciones.index','negociaciones.aceptar','negociaciones.rechazar','negociaciones.contraoferta',
'negociaciones.store_contraoferta','negociaciones.store','negociaciones.verChat','usuarios.index','usuarios.show',
'usuarios.edit','usuarios.update','usuarios.destroy','usuarios.toggle-status','profile',
'update-profile','direcciones.index','direcciones.create','direcciones.store',
'direcciones.show','direcciones.edit','direcciones.update','direcciones.destroy','items.VerDetalle',
'items.talentoedit','items.talentoupdate','items.admintalento','items.AddTalento',
'items.talento_create','messages.index','messages.create','messages.store','messages.show',
'messages.markAsRead','messages.unreadCount','notificaciones.listar','notificaciones.leido','categorias-item.store','categorias-item.update',
'categorias-item.destroy','updateProducts','tu_cuenta','login','login.post',
'logout','google.login','password.request','password.email',
'password.reset','password.update','registro.usuario','registro',
'micuenta','usuario.tipo.edit','usuario.tipo.update','items.user','items.create',
'items.store','items.gestion','items.edit','items.update',
'items.destroy','verification.notice','verification.verify','verification.resend','admin.index',
'admin.stats.index','admin.stats.data','admin.compras.show','admin.compras.estado','admin.ventas.show',
'admin.intercambios.show','admin.intercambios.estado','storage.local',);
        registerArgumentsSet('views', 
'addProduct.Edit-form','addProduct.addProduct','admin.compras.index','admin.compras.show','admin.index',
'admin.intercambios.show','admin.partials.tabla-compras','admin.partials.tabla-intercambios','admin.partials.tabla-ventas','admin.stats',
'admin.ventas.show','allviews.addProduct.addProduct','allviews.article.article','allviews.blank+18.blank+18','allviews.blank-intercambiar.blank-intercambio',
'allviews.blank-lista.blank-lista','allviews.blank.blank','allviews.carrito.carrito','allviews.como-vender.como-vender','allviews.contactanos.contactanos',
'allviews.direcciones.direcciones','allviews.empleos.empleos','allviews.envios.envios','allviews.historial.historial','allviews.iniciar-sesion.iniciar-sesion',
'allviews.intercambio.intercambio','allviews.otras-categorias.otras-categorias','allviews.payment-premium.payment-premium','allviews.payment.payment','allviews.perfil.editar-perfil-premium.editar-perfil-premium',
'allviews.perfil.editarPerfil.editarPerfil','allviews.perfil.index','allviews.perfil.perfil-usuario-premium.perfil-usuario-premium','allviews.perfil.perfil-usuario.perfilUsuario','allviews.perfil.premium.premium',
'allviews.premium-upgrade.primium-upgrade','allviews.product-intercambio.product-intercambio','allviews.product.product','allviews.realizar-compra.realizar-compra','allviews.realizar-intercambio.realizar-intercambio',
'allviews.recuperar.recuperar','allviews.registrarse.registrarse','allviews.responsabilidad.responsabilidad','allviews.sobre-nosotros.sobre-nosotros','allviews.tu-cuenta.contraseña.contrasenna',
'allviews.tu-cuenta.tu_cuenta','allviews.tu-cuenta.updatePassword.updatePassword','allviews.tu-cuenta.updateProducts.updateProducts','allviews.update.update','auth.passwords.email',
'auth.passwords.reset','ayuda.ayuda','blank-intercambiar.intercambio','cambiar_tipo_usuario','carrito.carrito',
'carrito.carrito_show','carrito.checkout','carrito.negociaciones','categorias.por-categoria','como-vender.como-vender',
'components.negociaciones-modal','components.notificaciones','compras.compra','compras.xxxxxxxcompra','contactanos.contact',
'contraseña.contrasenna','direcciones.direcciones','empleos.empleos','envios.envios','formularioImagenes',
'google_redirect','historial.historial','home','iniciar-sesion.iniciar-sesion','layouts.app',
'login','negociaciones.contenido','pagination::custom','partials.footer','partials.header',
'partials.menu','partials.negociaciones-list','password_email','password_reset','perfil.editar-perfil-premium.editar-perfil-premium',
'perfil.editarPerfil.editarPerfil','perfil.index','perfil.perfil-usuario-premium.perfil-usuario-premium','perfil.perfil-usuario.perfilUsuario','perfil.premium.premium',
'product-intercambio.product-intercambio','productos.crear-item','productos.mis-productos','productos.producto-detalle','productos.ver-detalle',
'realizar-compra.realizar-compra','realizar-intercambio.realizar-intercambio','registrarse.registrarse','registro','responsabilidad.responsabilidad',
'sobre-nosotros.about','talentos.admin-talento','talentos.agregar-talentos','talentos.talentoEdit-form','test-pagination',
'tu-cuenta.tu_cuenta','tu-cuenta.updatePassword.updatePassword','tu-cuenta.updateProducts.updateProducts','vendor.pagination.custom','verify-email',
...
'pagination.showing','pagination.to','pagination.of','pagination.results','pagination.Go to page :page',
...
'validation.prohibited_if_accepted','validation.prohibited_if_declined',);
...
'UPLOAD_LIMIT','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL','LOG_STACK',
'LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
'SESSION_PATH','SESSION_DOMAIN','SESSION_SECURE_COOKIE','CACHE_STORE','CACHE_PREFIX',
'QUEUE_CONNECTION','FILESYSTEM_DISK','DB_CONNECTION','DB_HOST','DB_PORT',
'DB_DATABASE','DB_USERNAME','DB_PASSWORD','REDIS_CLIENT','REDIS_HOST',
...
'STRIPE_SECRET','STRIPE_KEY','PAYMENT_DRIVER','CARDNET_ENV','CARDNET_MERCHANT_ID',
'CARDNET_TERMINAL_ID','CARDNET_TOKEN','CARDNET_ENVIRONMENT','IMGBB_API_KEY','IMGBB_ALBUM_ID',
'GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI','BROADCAST_CONNECTION','REVERB_APP_ID',
