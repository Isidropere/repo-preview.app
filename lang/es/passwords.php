...
return [
    ...
    | que son dadas por el gestor de contraseñas para un intento de actualización de contraseña
    | con resultado fallido debido a una contraseña inválida o token de restablecimiento inválido.
    |
    */
