...
return [
    ...
    */
    ...
    | la convención "nombre-atributo.nombre-regla" para nombrar las líneas. Esto permite
    | especificar rápidamente un mensaje personalizado para una regla de atributo dada.
    |
    */
