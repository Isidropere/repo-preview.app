<div class="relative flex items-center">
    <button id="hs-dropdown-floating-dark"
        type="button"
        class="hs-dropdown-toggle relative flex items-center justify-center p-2 text-primary hover:text-hoverPrimary no-tooltip"
        data-tooltip="Notificaciones" title="Notificaciones" data-astro-cid-pwmmw5ba>
        ...
        <span id="contadorNotificaciones"
              class="absolute -top-1 -right-1 z-10 bg-secondary text-white rounded-full text-xs font-bold px-1.5 leading-none"
              style="font-size:10px;transition:transform .2s;min-width:18px;text-align:center;">0</span>
    </button>
