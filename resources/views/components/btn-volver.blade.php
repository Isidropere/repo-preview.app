...
<div style="margin-bottom: 1rem;">
    <a href="{{ $backUrl ?? route('home') }}"
       onclick="if (document.referrer && document.referrer !== window.location.href) { try { const ref = new URL(document.referrer); const cur = new URL(window.location.href); if (ref.host === cur.host && ref.pathname !== cur.pathname) { window.location.href = document.referrer; return false; } } catch(e) {} } if (window.history.length > 1) { window.history.back(); return false; }"
