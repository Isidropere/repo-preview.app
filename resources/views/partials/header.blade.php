                           ...
                           data-tooltip="Carrito" title="Mi carrito">
                            ...
                            <a href="{{ route('negociaciones.mis') }}"
                               ...
                               title="Mis intercambios">
                                <span id="badgeIntercambios" class="absolute top-0 right-0 bg-primary text-white rounded-full text-xs font-bold px-1.5 leading-none" style="font-size:10px;transition:transform .2s;">
                                    0
                                </span>
