                        ...
                        <div class="mt-3 text-left sm:mt-0 w-full">
                            ...
                            <div class="mt-2 text-gray-700 text-sm leading-relaxed space-y-6 max-h-[60vh] overflow-y-auto pr-2">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <!-- Correo -->
                                    <div class="flex flex-col items-center text-center p-6 rounded-2xl border border-gray-100 hover:border-primary/20 hover:bg-orange-50/10 transition-colors">
                                        <div class="bg-orange-50 p-4 rounded-full mb-4">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" class="fill-primary">
                                                <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path>
                                            </svg>
                                        </div>
                                        <p class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Correo Electrónico</p>
                                        <a href="mailto:cambialord.com@gmail.com?subject=Contacto%20a%20Cambialo%20RD" class="text-sm font-bold text-gray-800 hover:text-primary transition-colors break-all">cambialord.com@gmail.com</a>
                                    </div>
                                    ...
                                    <div class="flex flex-col items-center text-center p-6 rounded-2xl border border-gray-100 hover:border-primary/20 hover:bg-orange-50/10 transition-colors">
                                        ...
                                        <p class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Instagram</p>
                                        <a href="https://instagram.com/cambialorddominicana" target="_blank" rel="noopener noreferrer" class="text-sm font-bold text-gray-800 hover:text-primary transition-colors break-words max-w-full">Cambialorddominicana</a>
                                    </div>
                                    ...
                                    <div class="flex flex-col items-center text-center p-6 rounded-2xl border border-gray-100 hover:border-primary/20 hover:bg-orange-50/10 transition-colors">
                                        ...
                                        <p class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Facebook</p>
                                        <a href="https://facebook.com/cambialord" target="_blank" rel="noopener noreferrer" class="text-sm font-bold text-gray-800 hover:text-primary transition-colors">Cámbialo RD</a>
                                    </div>
                                </div>
                            </div>
                        </div>
