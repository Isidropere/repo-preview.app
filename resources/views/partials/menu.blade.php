<div id="navbar-secondary-content" class="hs-overlay hs-overlay-open:translate-x-0 hidden -translate-x-full fixed top-0 start-0 transition-all duration-300 transform h-full max-w-xs w-full z-[80] bg-white border-e overflow-y-auto" tabindex="-1">
    ...
    <div class="p-4">
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(6)) }}">
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(27)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(9)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(13)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(26)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(14)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(15)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(2)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(3)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(7)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(16)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(17)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(8)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(4)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(25)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(23)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(20)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(28)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(29)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(24)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
        ...
        <a class="group flex gap-x-5 text-gray-800 transition-all duration-300 hover:bg-gray-200 rounded-lg p-4" href="{{ route('categorias.show', \App\Helpers\HashIdHelper::encode(19)) }}">
            <div class="grow flex gap-x-2 fill-secondary"> 
