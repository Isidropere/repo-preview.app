...
@section('title', 'Cómo realizar un intercambio - Cambialord')
                ...
                <div class="flex flex-col md:flex-row items-start">
                    <div class="flex-shrink-0 mb-6 md:mb-0 md:mr-6 w-full md:w-1/3">
                        <div class="bg-gray-200 h-64 flex items-center justify-center overflow-hidden rounded-xl border border-gray-100">
                            @if($paso->imagen)
                            <img src="{{ $paso->imagen }}" alt="{{ $paso->titulo }}" class="w-full h-full object-cover" onerror="this.onerror=null; this.style.display='none';">
                            @else
