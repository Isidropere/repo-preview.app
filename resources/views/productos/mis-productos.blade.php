    ...
    <main class="min-h-screen bg-gray-50 py-8">
        <div class="container mx-auto px-4">
            ...
            <div class="flex justify-between items-center mb-6">
                 <h3 class="text-4xl text-primary font-semibold mb-6">Mis Productos</h3>
                <a href="{{ route('items.create') }}" class="bg-primary hover:bg-hoverPrimary text-white px-4 py-2 rounded-md flex items-center">
                ...
                <div class="divide-y divide-gray-200">
                    ...
                    @empty
                        <div class="p-8 text-center">
                            ...
                            <h3 class="mt-2 text-lg font-medium text-gray-900">No tienes productos</h3>
                            <p class="mt-1 text-gray-500">Comienza agregando tu primer producto.</p>
                            <div class="mt-6">
                                <a href="{{ route('items.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary hover:bg-hoverPrimary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
