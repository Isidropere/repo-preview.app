        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-4 border-b border-gray-100 flex flex-col sm:flex-row gap-3">
                <div class="flex-1 relative">
                    ...
                    <input type="text" id="searchInput" placeholder="Buscar producto..." class="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary bg-gray-50">
                </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="w-16 h-16 rounded-xl overflow-hidden bg-gray-100 flex-shrink-0 cursor-pointer border border-gray-200" onclick="abrirImagen(this.querySelector('img')?.src)">
                            @if($item->imagenes->isNotEmpty())
                                ...
                                @endphp
                                <img src="{{ $imageUrl }}" alt="{{ $item->item }}" class="w-full h-full object-cover" onerror="this.onerror=null;this.src='{{ asset('imgs/defaults/producto_default.svg') }}'">
                            @else
