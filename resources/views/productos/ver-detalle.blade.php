                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('categorias.show', $item->categoria->id_categoria_item) }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-primary md:ml-2">{{ $item->categoria->categoria }}</a>
                        </div>
                    </li>
