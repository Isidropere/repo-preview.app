...
class ItemController extends Controller
{
    ...
    public function AddTalento(Request $request)
    {
        ...
        try {
            ...
            $messages = [
                ...
                'valor.required_if' => 'El precio es obligatorio si la modalidad incluye venta.',
                ...
                'tipo_trans.required' => 'Debe seleccionar una modalidad de negocio',
                'tipo_trans.in' => 'La modalidad de negocio seleccionada no es válida',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $messages = [
                ...
                'imagenes.*.mimes' => 'Solo se permiten imágenes JPEG, PNG, JPG, GIF o WEBP',
                'imagenes.*.max' => 'Las imágenes no deben pesar más de 2MB',
                'peso_lbs.required' => 'El peso es obligatorio',
                'peso_lbs.numeric' => 'El peso debe ser un número válido',
                'peso_lbs.gt' => 'El peso debe ser mayor a cero',
                'alto_cm.required' => 'El alto es obligatorio',
                'alto_cm.numeric' => 'La altura debe ser un número válido',
                'alto_cm.gt' => 'El alto debe ser mayor a cero',
                'ancho_cm.required' => 'El ancho es obligatorio',
                'ancho_cm.numeric' => 'El ancho debe ser un número válido',
                'ancho_cm.gt' => 'El ancho debe ser mayor a cero',
                'profundo_cm.required' => 'La profundidad es obligatoria',
                'profundo_cm.numeric' => 'La profundidad debe ser un número válido',
                'profundo_cm.gt' => 'La profundidad debe ser mayor a cero',
                'presentacion.required' => 'Rellene la descripción de su producto o servicio, que se encuentra en la sección de Especificar Dimensiones.',
    ...
    public function VerDetalle($slug)
    {
        try {
            ...
            Log::debug('Item encontrado correctamente', ['item_id' => $item->id_item]);
